...
class Record:
    ...
    def remove_phone (self, phone: str):
        ...
        if any(p.value == phone_to_remove for p in self.phones):

            self.phones = list(filter(lambda p: p.value == phone_to_remove, self.phones))
    ...
    def find_phone (self, phone: str) -> Phone | None:
        ...
        return next((p for p in self.phones if p.value == phone_to_find), None)
